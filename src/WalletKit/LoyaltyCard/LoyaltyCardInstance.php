...
/**
 * Class HMS Wallet API: Loyalty Card Instance
 *
...
class LoyaltyCardInstance extends WalletKit implements WalletPass {
    ...
    public function create( array $instance ): bool|\stdClass {
        $url = $this->base_url . Constants::WALLET_LOYALTY_CARD_INSTANCE;
        return $this->request('POST', $url, $this->auth_headers(), (object) $instance);
    }

    /** @noinspection PhpParameterNameChangedDuringInheritanceInspection */
    public function query( string $instance_id ): bool|\stdClass {
        $url = $this->base_url . Constants::WALLET_LOYALTY_CARD_INSTANCE . '/' . $instance_id;
