...
/**
 * Class HMS Wallet API: Boarding Pass Instance
 *
 ...
 */
class BoardingPassInstance extends WalletKit implements IWalletPass {
    ...
    public function create( array $instance ): bool|\stdClass {
        $url = $this->base_url . Constants::WALLET_BOARDING_PASS_INSTANCE;
        return $this->request('POST', $url, $this->auth_headers(), (object) $instance);
    }

    /** @noinspection PhpParameterNameChangedDuringInheritanceInspection */
    public function query( string $instance_id ): bool|\stdClass {
        $url = $this->base_url . Constants::WALLET_BOARDING_PASS_INSTANCE . '/' . $instance_id;
