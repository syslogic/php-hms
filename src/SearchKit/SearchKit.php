 ...
 * @link https://developer.huawei.com/consumer/en/doc/development/HMSCore-Guides/app-gallery-connect-0000001057712438 Configuring App Information in AppGallery Connect
 * @link https://developer.huawei.com/consumer/en/doc/development/HMSCore-References/overview-0000001057087079 SearchKit
...
class SearchKit extends Wrapper {
     ...
     * @link https://developer.huawei.com/consumer/en/doc/development/HMSCore-References/language-code-0000001057569148 Language Codes
     */
     ...
     * @link https://developer.huawei.com/consumer/en/doc/development/HMSCore-References/search-region-code-0000001057330966 Region Codes
     */
    ...
    /**
     * @link https://developer.huawei.com/consumer/en/doc/development/HMSCore-References/web-search-0000001056849539 Searching for a Web Page
    ...
    /**
     * @link https://developer.huawei.com/consumer/en/doc/development/HMSCore-References/image-search-0000001057330814 Searching for an Image
     * @param string $keyword Search keyword.
     * @param string $language Supported search languages. The default value is en.
     * @param string $region Supported search regions. The default value is ww.
     * @param int $page_number Number of a search result page. The value ranges from 1 to 100, and the default value is 1.
    ...
    /**
     * @link https://developer.huawei.com/consumer/en/doc/development/HMSCore-References/video-search-0000001057330836 Searching for a Video
     * @param string $keyword Search keyword.
     * @param string $language Supported search languages. The default value is en.
     * @param string $region Supported search regions. The default value is ww.
     * @param int $page_number Number of a search result page. The value ranges from 1 to 100, and the default value is 1.
    ...
    /**
     * @link https://developer.huawei.com/consumer/en/doc/development/HMSCore-References/news-search-0000001055690931 Searching for News
     * @param string $keyword Search keyword.
     * @param string $language Supported search languages. The default value is en.
     * @param string $region Supported search regions. The default value is ww.
     * @param int $page_number Number of a search result page. The value ranges from 1 to 100, and the default value is 1.
